...
# Get root directory (parent of agent directory)
root_dir = os.path.dirname(os.path.dirname(__file__))
region_name_path = os.path.join(root_dir, 'iata_code', 'region_name.json')

with open(region_name_path, 'r', encoding='utf-8') as f:
    data = json.load(f)
